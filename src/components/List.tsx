...
export default function List({
  ...
  const handleEdit = () => {
    const task: Todo = { id, name, level, time, description, status };
    action?.onClick(task);
      ...
      <tr>
        ...
        <td>
          <button
            ...
            onClick={() =>
              action?.dispatch({ type: ACTIONS.TOGGLE_TODO, payLoad: { id } })
            }
          >
            Done
          </button>
          ...
          <button
            ...
            onClick={() =>
              action?.dispatch({ type: ACTIONS.DROP_LIST, payLoad: { id } })
            }
          >
            Drop
          </button>
